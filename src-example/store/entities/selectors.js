...
export const getDenormalizedDetail = (state = initialState, entity, id) => denormalize(id, schemas[entity], state)

export const getDenormalizedList = (state = initialState, entity, ids) => denormalize(ids || getEntityKeys(state, entity), [schemas[entity]], state)
